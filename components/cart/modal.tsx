...
export default function CartModal({ cart }: { cart: Cart | undefined }) {
  ...
  return (
    <>
      <OpenCart quantity={cart?.totalQuantity} onClick={openCart} />
      <Transition show={isOpen}>
        <Dialog onClose={closeCart} className="relative z-50">
          ...
          >
            <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-neutral-40 bg-neutral-10/80 p-6 text-black backdrop-blur-xl md:w-[390px]">
              ...
              {!cart || cart.lines.length === 0 ? (
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                  ...
                  <div className="py-4 text-sm text-neutral-100">
                    ...
                    {/*  />*/}
                    {/*</div>*/}
                    <div className="mb-3 flex items-center justify-between border-b border-neutral-40 pb-1 pt-1">
                      <p>Shipping</p>
