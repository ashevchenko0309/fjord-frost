...
export const MainBannerItem: FC<MainSliderItemProps> = ({
  ...
  return (
    <div className="bg-white md:py-20 overflow-hidden xl:relative xl:bg-transparent xl:py-0">
      <div className="px-4 pb-8 xl:pb-0">
        ...
        <ul className="flex h-1 items-center gap-8 xl:hidden">
          <li className="relative">
            <span
              className={clsx(
                'absolute',
                index === 0 ? '-mt-px h-1 bg-primary-main w-5' : 'h-0.5 bg-primary-border w-2.5'
              )}
            />
          </li>
          <li className="relative">
        ...
        <p className="py-4 text-sm leading-5 text-neutral-50">{description}</p>
