        ...
        <div className="relative mb-6 lg:mb-0">
          ...
          <div className="absolute bottom-0 flex w-full justify-between px-4 pb-4 lg:px-5 lg:pb-6">
            ...
            <SolidButton
              text="Discover"
              size="small"
              className="absolute right-5 bg-neutral-10 opacity-0 lg:px-3 lg:py-2 lg:group-hover:animate-fade-up lg:group-hover:animate-duration-300 lg:group-hover:animate-once lg:group-hover:animate-ease-out xl:px-6 xl:py-2.5"
            />
          </div>
        </div>
