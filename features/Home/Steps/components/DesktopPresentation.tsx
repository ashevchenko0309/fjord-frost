...
const DesktopPresentation: FC<{ routine: ROUTINES; products: Product[] }> = ({
  routine,
  products
}) => {
  ...
  if (routine === ROUTINES.FULL) {
    return (
        <div>
          <div className="mb-8 grid grid-cols-12 gap-8 lg:mb-14">
          ...
          <div className="col-span-4">
            <div className="flex h-full flex-col justify-between rounded-2xl bg-neutral-10">
              ...
              <Image
                  ...
                  alt="oil free hydratuing face gel"
                  className="h-full max-h-[332px] w-full rounded-b-2xl object-cover xl:object-[0%_10%]"
                  unoptimized
                  height={332}
                  width={320}
              />
